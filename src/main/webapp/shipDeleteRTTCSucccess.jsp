	...
	<div class="wrapper">
                 ...
                 with font-awesome or any other icon font library -->
						...
						<li class="nav-item menu-open"><a href="#" class="nav-link">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a href="ships.jsp" class="nav-link"> <i
										class="far fa-circle nav-icon"></i>
										<p>郵輪管理</p>
								</a></li>
								<li class="nav-item"><a href="#" class="nav-link"> <i
		...
		<div class="content-wrapper">
			...
			<div class="content">
				<div class="container">
					<div class="row">
						<div class="col-md-12 justify-content-center text-align-center">
							<form method="post"
								action="<%=request.getContextPath()%>/ShipServlet">
								<input type="hidden" name="action"
									value="getOne_For_Update_Ship" /> <input
									type="hidden" name="shipNo" value="${shipNo }" /> <input
									class="display-flex" type="submit" name="updateS" value="刪除成功"
									text-align="center"
