...
<%
	Integer rTTCNo =(Integer)request.getAttribute("rTTCNo");

	RoomTypeTotalCountVO roomTypeTotalCountVO = (RoomTypeTotalCountVO) request.getAttribute("roomTypeTotalCountVO");
	RoomTotalDAOImpl rtdSVC = new RoomTotalDAOImpl();
	RoomTotalVO roomTotalVO =rtdSVC.getRTTC(rTTCNo);
	pageContext.setAttribute("list",roomTotalVO);
%>
<!DOCTYPE html>
<!--
                                            ...
                                            <table id="table" data-toggle="table" data-search="false" data-filter-control="true"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><%=roomTotalVO.getRoomType() %>
                                                        </td>
                                                        <td><%=roomTotalVO.getMaxCountOfRoomType() %><input type="hidden" name="maxCountOfRoomType" value="<%=roomTotalVO.getMaxCountOfRoomType() %>"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                               
                                                
                                                <input type="hidden" name="action" value="getOne_For_Update_Ship">
                                                <input type="hidden" name="shipNo" value="<%=roomTotalVO.getShipNo() %>">
                                                <input  class="col-12" class="offset-8" type="submit" name="updateS" value="更新成功" text-align=center
