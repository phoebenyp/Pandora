                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                       <table class=" col-md-12" id="table" data-toggle="table" data-search="true" data-filter-control="true"
                                        ...
                                        <tbody>
                                        	<c:forEach var="cruiseLineVO" items="${list}">
	                                            ...
	                                            <tr>
	                                                ...
	                                                <td>
	                                                    <form method="post"  action="<%=request.getContextPath()%>/CruiseLineServlet">
	                                                        <input name="action" type="hidden" value="selectCruiseNo">
