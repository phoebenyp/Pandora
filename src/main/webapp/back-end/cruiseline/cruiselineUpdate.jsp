                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                        <form method="post"  action="cruise2update.html">
                                        <input type="hidden" name="cruiseLineNo" value="${cruiseLineVO.cruiseLineNo}">
                                            <select name="" id="" style="width:250px;float: center;">
                                        ...
                                        <div class="col-md-4">
                                            <button style="margin-right: 0%;width:250px;float: right;">新增停靠點</button>
                                        </div>
...
<%--                                                 <td>${pNLVO.portName}</td> --%>
												<td><select name="portOfCallNo" style="width:250px;">
			                                            <c:forEach items="${plist}"	 var="pVO">
                                                ...
                                                <td>
                                                	<input name="portOfCallSequence" type="hidden" value="${pNLVO.portOfCallSequence }">
                                                	<input name="cruiseLinesNo" type="hidden" value="${pNLVO.cruiseLinesNo}">
                                                    <input name="action" type="hidden" value="updatePCL">
