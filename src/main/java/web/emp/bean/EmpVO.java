...
public class EmpVO implements Serializable {
	...
	private Integer empCellphoneNo;
	...
	public Integer getEmpCellphoneNo() {
		return empCellphoneNo;
	}



	public void setEmpCellphoneNo(Integer empCellphoneNo) {
	...
	public EmpVO(Integer employeeId, byte[] empPictureId, String englishLastName, String englishFirstName,
			...
			LocalDateTime startDate, LocalDateTime resignationDate, String password, Integer empCellphoneNo,
